...
def main():
    ...
    args.user_set, args.item_set = get_user_item_unique(args.data_file)
    ...
    print(f"Load model from {args.checkpoint_path} for ensemble!")
    rating_pred = trainer.ensemble()
    rating_pred.index = args.user_set
    
    # rating_pred.reset_index(drop=True, inplace=True)
    rating_pred.to_csv("ensemble.csv")
